...
import Receptionist_Admin from '../../features/Roles/Admin/Receptionist/Receptionist'
import { UserRoleEnum } from '@/utils/Enum'

export const Route = createFileRoute('/(Receptionist)/receptionist')({
...
function RouteComponent() {
  ...
  const renderReceptionist = () => {
    switch (roleName) {
      case 'ADMIN':
        return <Receptionist_Admin auth={auth} />
      default:
