...
import Integrations_admin from '@/features/Roles/Admin/Access/Integrations'
...
export const Route = createFileRoute('/(Access)/integrations')({
...
function RouteComponent() {
  ...
  const renderIntegrations = () => {
    switch (roleName) {
      case 'ADMIN':
        return <Integrations_admin auth={auth} />
      default:
